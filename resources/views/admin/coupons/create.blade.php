...
<div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem;">
    <div>
        <h1 style="font-size: 1.5rem; font-weight: 700; color: var(--text-main); margin-bottom: 0.5rem;">Thêm Mã Giảm Giá Mới</h1>
        <p style="color: var(--text-muted); font-size: 0.875rem;">Tạo chương trình ưu đãi mới cho khách hàng</p>
    </div>
    ...
    <form action="{{ route('admin.coupons.store') }}" method="POST">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem; margin-bottom: 1.5rem;">
            <div>
                ...
                <input type="number" name="discount_percent" class="form-control" value="{{ old('discount_percent') }}" min="1" max="100" required>
        ...
        <button type="submit" class="btn">Thêm Mã Giảm Giá</button>
    </form>
</div>
@endsection
